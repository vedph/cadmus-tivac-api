...
using Cadmus.Tivac.Services;
using Serilog.Exceptions;

namespace CadmusTivacApi
{
    /// <summary>
    /// Startup.
    /// </summary>
    public sealed class Startup
    {
        ...
        private static void ConfigureSwaggerServices(IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "API",
                    Description = "Cadmus Tivac Services"
                });
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // repository
            services.AddSingleton<IRepositoryProvider, TivacRepositoryProvider>();
            // part seeder factory provider
            services.AddSingleton<IPartSeederFactoryProvider,
                TivacPartSeederFactoryProvider>();
